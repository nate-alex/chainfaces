...
contract FaceGolfBalls is ERC20, Ownable, ReentrancyGuard {
    ...
    string constant public name = "ChainFace Golf Balls v0";
    string constant public symbol = "GOLF0";
    ...
    function mintTokens() public onlyOwner{
        ...
        _mint(msg.sender, (maxTokens).mul(10**1));
    }
    }
